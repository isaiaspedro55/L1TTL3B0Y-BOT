// ════════════════════════════════════════════════
// ✅ COMANDO !DINO — Dino Runner interativo (HTML)
// ════════════════════════════════════════════════
const { generateWAMessageFromContent } = require("@itsliaaa/baileys");

const DINO_HTML = `<html dir="ltr" lang="en" class="offline"><head>
  <meta charset="utf-8">
...
<!-- main script about Dino Game Runner -->
<script>
...
<!-- Runner Game Object init or config? -->
<script>
  ...
  <!-- Enum -->
  <script jstcache="0">loadTimeData.data = {"details":"Details","dinoGameA11yAriaLabel":"Dino game, press space to jump and play","dinoGameA11yGameOver":"Game over, your score is $1.","dinoGameA11yHighScore":"Your highest score is $1.","dinoGameA11yJump":"Jump!","dinoGameA11yStartGame":"Game started.","errorCode":"ERR_INTERNET_DISCONNECTED","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"10.10.2.101","msg":"No internet"},"hideDetails":"Hide details","iconClass":"icon-offline","language":"en","suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"Checking the network cables, modem, and router"},{"summary":"Reconnecting to Wi-Fi"},{"summary":"\\u003Ca href=\\"javascript:diagnoseErrors()\\" id=\\"diagnose-link\\">Running Windows Network Diagnostics\\u003C/a>"}],"suggestionsSummaryListHeader":"Try:","summary":{"failedUrl":"http://10.10.2.101:15672/","hostName":"10.10.2.101","msg":"No internet"},"textdirection":"ltr","title":"10.10.2.101"};
</script>
<!-- some script about  jst* attribute tag in this HTML -->
<script jstcache="0"> 
  (function() {
  function l(a, b, c) {
  ...
  if (e = c.jsvalues) for (d = 0, g = e.length; d < g; d += 2) if (f = e[d], h = y(a, e[d + 1], b), "$" == f.charAt(0)) a.a[f] = h;
  else if ("." == f.charAt(0)) {
  f = f.substr(1).split(".");
...
async function enviarDino(sock, jid, quotedMsg) {
  const unifiedPayload = {
    response_id: "dino_" + Date.now(),
    sections: [{
      view_model: {
        primitive: {
    ...
    botForwardedMessage: {
      message: {
        richResponseMessage: {
          ...
          unifiedResponse: {
            data: Buffer.from(JSON.stringify(unifiedPayload)).toString("base64")
          },
          contextInfo: {
            forwardingScore: 1,
            isForwarded: true,
