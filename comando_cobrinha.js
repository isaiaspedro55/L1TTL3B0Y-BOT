// ════════════════════════════════════════════════
// ✅ COMANDO !COBRINHA — Colete as frutas
// ════════════════════════════════════════════════
const { generateWAMessageFromContent } = require("@itsliaaa/baileys");

const COBRINHA_HTML = `<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
<body>
<div class="card">
<h1>🐍 Cobrinha</h1><p>Colete as frutas</p>
...
async function enviarCobrinha(sock, jid, quotedMsg) {
  const htmlPayload = {
    response_id: "cobrinha_" + Date.now(),
    sections: [{
      view_model: {
        primitive: {
          __typename: "GenAIaeacdsnwHtmlPrimitive",
          payload: COBRINHA_HTML,
  ...
  const content = {
    botForwardedMessage: {
      message: {
        richResponseMessage: {
          messageType: 1,
          submessages: [{ messageType: 2, messageText: "🐍 Cobrinha" }],
