...
.card{width:100%;max-width:440px;background:#fff;border:2px solid #047857;border-radius:22px;padding:13px;text-align:center;box-shadow:0 10px 30px #0002}
h1{font-size:30px;color:#047857;margin:2px}p{color:#64748b;font-size:14px;margin:3px 0 8px}
#placar{font-size:18px;font-weight:900;margin:7px;color:#047857}
...
.modal button{margin-top:14px;width:100%;background:#047857;color:#fff}
...
canvas{width:100%;max-height:68vh;border-radius:18px;border:2px solid #047857;touch-action:none;background:#f8fafc}
</style>
</head>
<body>
<div class="card">
<h1>🎱 Sinuca</h1><p>Faça a tacada</p>
...
<div class="row"><button onclick="resetar()" style="background:#e5e7eb">🔄 Novo</button><button onclick="som()" id="snd" style="background:#047857;color:#fff">🔊 Som</button></div>
</div>
<script>
  ...
  const content = {
    botForwardedMessage: {
      message: {
        richResponseMessage: {
          messageType: 1,
          submessages: [{ messageType: 2, messageText: "🎱 Sinuca" }],
